public class third {
    public static void main(String[] args) {
        ...
        // В итоге мы смотрим значения, сравниваем, если они разных знаков - указателю либо левого, либо правого значения присваиваем значение, которое стоит между ними (т.е. в нашем случае ровно половинное, так сказать)
